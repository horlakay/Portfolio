...
#### 📡 Smart Wi-Fi Attendance System
Real-time occupancy detection via Wi-Fi — built with Firebase & Android.

#### 👶 Age Estimation via CNNs
Trained a CNN model to estimate human age from facial images.

#### 🎙️ Voice-Controlled Electrical Switch
Arduino + LSTM model to recognize voice commands for switching.

#### ⚙️ DevOps Cloud Pipeline
CI/CD pipeline for containerized apps using Terraform and GitHub Actions.

#### 🛰️ Satellite Image Annotation
Labeled commercial/residential zones using SuperAnnotate.
...
- 🧠 Mentored Google Africa Developers (GADS 2022 – Cloud Track)
- 💻 Worked across AI Ops, Embedded Systems, and Classical ML
- 🔍 Fascinated by Quantum Mechanics & Algorithms

---

<p align="center">Let's build something incredible together 🌍</p>
